namespace GreenLeafMobileService.Migrations
{
    ...
    public partial class codeclasses : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IsMailOrder = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        TagPrice = c.Decimal(nullable: false, precision: 18, scale: 2),
                        ...
                        GlCode = c.String(),
                        GlCost = c.Decimal(precision: 18, scale: 2),
                        VendorCode = c.String(),
                        VariantId = c.String(),
                        LocationId = c.String(maxLength: 128),
                ...
                c => new
                    {
                        ...
                        OriginalId = c.Long(nullable: false),
                        Name = c.String(),
                        City = c.String(),
                        Province = c.String(),
                        Phone = c.String(),
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Roles", new[] { "CreatedAt" });
            DropIndex("dbo.Users", new[] { "CreatedAt" });
            DropIndex("dbo.Users", new[] { "RoleId" });
            DropIndex("dbo.PaymentTypes", new[] { "CreatedAt" });
            DropIndex("dbo.Payments", new[] { "CreatedAt" });
            ...
            DropIndex("dbo.Invoices", new[] { "CreatedAt" });
