...
namespace GreenleafiManager
{
	...
	public partial class InventoryDetailViewController : UIViewController
	{
		...
		UILabel lblGL, lblSku, lblInfoLine1, lblInfoLine2, lblInfoLine3, lblPrice, lblSecretCode, lblTagPrice, lblMetal,lastCheckedOnDate;
		...
		{
			base.ViewDidLoad();
			InventScrollView.Frame = new CGRect(0, 63, this.View.Frame.Width, View.Frame.Height);
			var currentFrame = this.View.Bounds;
			var bounds = UIScreen.MainScreen.Bounds;
			//_scrollView = new UIScrollView(new CGRect(0, 65, this.View.Frame.Width, View.Frame.Height));
			InventScrollView.ContentSize = new CGSize(this.View.Frame.Width, this.View.Frame.Height + 10);
			//InitializeView();
			...
			InvoiceDescriptionLabel = new UILabel(new CGRect(Sku.Frame.X, Sku.Frame.Y + Sku.Frame.Height +5, Sku.Frame.Width, Sku.Frame.Height));
			InvoiceDescriptionLabel.ToInventoryLabel();
			InvoiceDescriptionLabel.Text = "Invoice Description";
			//if(InventoryItem.Sold)
			InventScrollView.AddSubview(InvoiceDescriptionLabel);
			...
			InventScrollView.AddSubview(InvoiceDescriptionTextField);
			...
			//if (InventoryItem.Sold)
			InventScrollView.AddSubview(InvoiceSaleLabel);
			InventScrollView.AddSubview(ShopifyButton);
			InventScrollView.AddSubview(LblShowInStore);
			InventScrollView.AddSubview(SwichShowInStore);
			...
			InventScrollView.AddSubview(InvoiceSalePriceTextField);

			lastCheckedOnDate = new UILabel(new CGRect(InvoiceSalePriceTextField.Frame.X, InvoiceSalePriceTextField.Frame.Y + InvoiceSalePriceTextField.Frame.Height, InvoiceSalePriceTextField.Frame.Width*2, InvoiceSalePriceTextField.Frame.Height));
			lastCheckedOnDate.ToInventoryLabel();
			InventScrollView.AddSubview(lastCheckedOnDate);
            ...
            ShowLoadingOverlay();
            InventoryItem.LoadImagesFromDrive();
            HideLoadingOverlay();
		}
		...
		public override void ViewWillAppear(bool animated)
		{
			...
			this.InventScrollView.InitKeyboardScrollView();
		}
		public override void ViewWillDisappear(bool animated)
		{
			base.ViewWillDisappear(animated);
			this.InventScrollView.UnsubscribeKeyboardScrollView();
		}
		...
		private async Task ConfigureView()
		{
			...
			InventScrollView.Add(barcodeEAN13);
			InventScrollView.AddSubview(img_UploadImage);//ProductImage);
		...
		//	var metalButtonText = String.IsNullOrWhiteSpace(InventoryItem.MetalCode) ? "Metal Code" : InventoryItem.MetalCode;
			var metalButtonText = String.IsNullOrWhiteSpace(metal) ? "Metal Code" : metal;
			MetalCodeButton.TitleLabel.Text = metalButtonText;
			MetalCodeButton.SetTitle(metalButtonText, UIControlState.Normal);
		}
		...
		public void SetupFields()
		{
			...
			lastCheckedOnDate.Text = !String.IsNullOrEmpty(InventoryItem.LastCheckedDate)
				? "Last Checked on Date " + InventoryItem.LastCheckedDate
				: "This item hasnt been checked yet.";

			InfoLine1.Text = InventoryItem.Info1;
			InfoLine2.Text = InventoryItem.Info2;
			InfoLine3.Text = InventoryItem.Info3;

			SwichShowInStore.On = InventoryItem.ShowOnWebsite;
		...
		private async Task<bool> performSave()
		{
			...
			InventoryItem.ShowOnWebsite = SwichShowInStore.On;
		...
		partial void UIButton538_TouchUpInside(UIButton sender)
		{
			...
			//var imagepath = "/Users/neha/Library/Developer/CoreSimulator/Devices/F26FC763-4354-4781-A609-9BFBFC76B873/data/Containers/Data/Application/5AD75970-CC95-484E-A0B1-63B699DDF0C0/Documents/21887357134_8048142275.png";
			UIImage image = new UIImage("bghome.png");
		...
		partial void ShopifyButton_TouchUpInside(NSObject sender)
		{
			if (!(!String.IsNullOrWhiteSpace(Sku.Text) && Sku.Text.Length == 6))
			{
