...
{
	public partial class UsersAlertViewController : UIView
	{
		...
		public UsersAlertViewController 
		...
		public UsersAlertViewController ( RectangleF bounds ) : base( bounds ) {
			Initialize();
		}
		...
		private void Initialize () {
			...
			var titleLabel=new UILabel() {Text = "Users"};
		...
		public class TableSource : UITableViewSource
		{
			...
			private UsersAlertViewController owner;
			public TableSource(string[] items, UsersAlertViewController owner )
			{
				TableItems = items;
				this.owner = owner;
			}
			...
			{
				//RMR should reall do this more OOP style but too busy atm

				owner.owner.UpdateUserCode(TableItems[indexPath.Row]);
				owner.CloseAlert();
