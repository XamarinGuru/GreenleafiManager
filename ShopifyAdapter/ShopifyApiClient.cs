...
namespace ShopifyAPIAdapterLibrary
{
    ...
    public class ShopifyAPIClient
    {
		...
		public async Task<object> Call(HttpMethods method, string path)
        {
            return await Call(method, path, null);
        }
        ...
        /// <seealso cref="http://api.shopify.com/"/>
        /// <returns>the server response</returns>
        public async Task<object> Call(HttpMethods method, string path, object callParams)
        {
        ...
        /// <seealso cref="http://api.shopify.com/"/>
        /// <returns>the server response</returns>
		public async Task<object> Get(string path, NameValueCollection callParams)
        {
			return await Call(HttpMethods.GET, path, callParams);
        }
        ...
        /// <seealso cref="http://api.shopify.com/"/>
        /// <returns>the server response</returns>
		public async Task<object> Post(string path, object data)
        {
			return await Call(HttpMethods.POST, path, data);
        }
        ...
        /// <seealso cref="http://api.shopify.com/"/>
        /// <returns>the server response</returns>
		public async Task<object> Put(string path, object data)
        {
			return await Call(HttpMethods.PUT, path, data);
        }
        ...
        /// <seealso cref="http://api.shopify.com/"/>
        /// <returns>the server response</returns>
        public async Task<object> Delete(string path)
        {
			return await Call(HttpMethods.DELETE, path);
        }
